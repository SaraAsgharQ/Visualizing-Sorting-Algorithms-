  ...
  render() {
    ...
    return (
      <div className="array-container">
        ...
        <button id="shellSort" style={{ marginRight: '8px' }} onClick={() => this.sort('shellSort')}>Modified Quick  Sort</button>
        <button id="cycleSort" style={{ marginRight: '8px' }} onClick={() => this.sort('cycleSort')}>8.2.4 Sort</button>
